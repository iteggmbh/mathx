export function	buildDomNode(kwargs,elementType) {
...
export class Button {
  ...
  constructor(kwargs) {
	...
	this.domNode = buildDomNode(kwargs,"div");
...
export function addAriaClickHandler(w,handler,useCapture) {

  if (isTouchDevice()) {
	return addTouchClickHandler(w,handler,useCapture);
  }
...
export function addTouchClickHandler(w,handler,useCapture) {
